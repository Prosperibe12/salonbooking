    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">All Salons</h1>
                                    <!-- breadcrumb Start-->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                            <li class="breadcrumb-item"><a href="#">All Salons</a></li> 
                                        </ol>
                                    </nav>
                                    <!-- breadcrumb End -->
                                </div>
        ...
        <div class="courses-area section-padding40 fix">
            <div class="container">
                ...
                <div class="row">
                    <?php
                        // listing all service provider in a page
                        // instantiating class
                        $getPage = new SalonAppDb;

                        // instantiating method
                        $objGet = $getPage->allProvider();

                        // echo "<pre>";
                        // print_r($objGet);
                        // echo "</pre>";
                        foreach ($objGet as $key => $value) {
                    ?>
                    <div class="col-lg-4">
