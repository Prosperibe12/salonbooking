...
<head>
    ...
    <title>Salon Booking|Search Service</title>
...
<main>
                            ...
                            <div class="hero__caption hero__caption2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Search Service</a></li> 
                                    </ol>
                                </nav>
                                <!-- breadcrumb End -->
                            </div>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title" align="center">Search Service</h2>
                </div>
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your servive name'" placeholder="Ex. Hair Cut, Body Massage">
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#name').keyup(function(){
            // get search value
            var getService = $('#name').val();

            // send search value to server asynchronously using $.ajax
            $.ajax({
                url: "ajax.php",
                type: "post",
