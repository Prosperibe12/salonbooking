...
<head>
    ...
    <title>Salon Booking|Women Section</title>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Women Section</h1>
                                    <!-- breadcrumb Start-->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                            <li class="breadcrumb-item"><a href="#">Women Section</a></li> 
                                        </ol>
                                    </nav>
                                    <!-- breadcrumb End -->
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <?php
                        ...
                        $getWomen = new SalonAppDb;

                        // instantiating method
                        $objWomen = $getWomen->womenSection();

                        // echo "<pre>";
                        // print_r($objWomen);
                        // echo "</pre>";
                        foreach ($objWomen as $key => $value) {
                    ?>
                    <div class="col-lg-4">
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                ...
                                <div class="properties__caption">
                                    ...
                                    <p>Dream your beauty and we will make your dream come true. Services that brings the elegance, confidence in you, are offered in our service.</p>
