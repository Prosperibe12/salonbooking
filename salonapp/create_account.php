        ...
        if (!empty($msg)) {
            ...
            if ($_POST['g-recaptcha-response'] != '') {
                ...
                if ($responseData->success) {
                    ...
                    if ($objReg->providerEmailExist(strip_tags(htmlspecialchars($_POST['email']))) == true) {
                        $msg = "<div class='alert alert-danger'>This Email Already Exist.</div>";
                    }else{

                        // supply function argument and submit to database
                        $userReg = $objReg->ServiceProviderReg(strip_tags(htmlspecialchars($_POST['name'])), strip_tags(htmlspecialchars($_POST['email'])), strip_tags(htmlspecialchars($_POST['password'])), $code);
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        <h2 style="text-align:right;">Register Your Business</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
                        <?php echo $msg; ?>
                        <form action="" method="post">
                            <input type="text" class="name" name="name" placeholder="Enter Your Business Name" value="" required>
                            <input type="email" class="email" name="email" placeholder="Enter Your Business Email" value="" required>
                            <input type="password" class="password" name="password" placeholder="Enter Your Password" required>
                             <div class="g-recaptcha" data-sitekey="6Le10eAeAAAAAD615_YrlzFLGJ288qddUqCRh0Wg"></div>
                            <button name="submit" class="btn" type="submit">Register</button>
                        </form>
                        <div class="social-icons">
                            <p>Have an account! <a href="signin_account.php">Login</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
