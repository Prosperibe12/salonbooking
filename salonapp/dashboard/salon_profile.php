                                ...
                                if ($_SERVER['REQUEST_METHOD'] =='POST') {
                                    ...
                                    if (!empty($error)) {
                                        ...
                                        echo "</div>";
                                            ...
                                            $update = $objupdate->salonProfileUpdate(strip_tags(htmlspecialchars($_POST['tel'])), strip_tags(htmlspecialchars($_POST['address'])), $_POST['category'], $_SESSION['salon_id']);

                                            if($update == true){
                                                echo "<div class='alert alert-success'>Profile Updated Succesfully</div>";
                                            }else{
                                                echo "<div class='alert alert-danger>$update</div>";
                                            }         
                                        }
                                }
                            } catch (Exception $e) {
                        ...
                        ?>
                                <form class="form-horizontal form-material" method="post" action="" enctype="multipart/form-data">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Tel. No</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Input your Tel No" name="tel" value="<?php if(isset($_POST['tel'])){
                                                echo $_POST['tel'];
                                            };?>" 
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="address" placeholder="Salon Address" value="<?php if(isset($_POST['address'])){
                                                echo $_POST['address'];
                                            }?>" 
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <select name="category" id="" class="form-control p-0 border-0" id="example-email">
                                                <option value="">Choose Salon Category</option>
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Salon Image</label>
                                        <div class="col-md-12 border-bottom p-0">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="hidden" name="saloncode" value="<?php echo $_SESSION['salon_code'];?>" 
                                                class="form-control p-0 border-0"> 
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
