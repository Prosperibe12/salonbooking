            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Service Page</h4>
                    </div>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                            ...
                            try {
                                if ($_SERVER['REQUEST_METHOD'] =='POST') {
                                    ...
                                    if (empty($_POST['category'])) {
                                        $error[] = "Choose a service to Add.";
                                    }
                                    if (empty($_POST['desc'])) {
                                        $error[] = "Add a short description for this service.";
                                    }
                                    if (empty($_POST['price'])) {
                                        $error[] = "Input a price for your service";
                                    }
                                    if (!empty($error)) {
                                        ...
                                        echo "</div>";
                                            ...
                                            $update = $objupdate->uploadService($_SESSION['salon_id'], $_POST['category'], strip_tags(htmlspecialchars($_POST['desc'])), strip_tags(htmlspecialchars($_POST['price'])));
                        ...
                        ?>
                                <form class="form-horizontal form-material" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Service</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <select name="category" id="" class="form-control p-0 border-0" id="example-email">
                                                <option value="">Choose Service</option>
                                                <?php
                                                    $getAll = new SalonAppDb;
                                                    $allServe = $getAll->getServices();
                                                    foreach ($allServe as $key => $value) {
                                                ?>
                                                <option value="<?php
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Service Description</label>
                                        <div class="col-md-12 border-bottom p-0">
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Service Image</label>
                                        <div class="col-md-12 border-bottom p-0">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="hidden" name="saloncode" value="" 
                                                class="form-control p-0 border-0"> 
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" type="submit">Upload Service</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
