<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty(strip_tags($_POST['email']))) {
            ...
            // make reference to method providerEmailExist
            if ($objClass->providerEmailExist(strip_tags($_POST['email'])) == true) {
               
                // make reference to method changePass
                $objPass = $objClass->pwdChange($code, strip_tags($_POST['email']));
                        ...
                        $mail = new PHPMailer(true);
                            ...
                            try {
                                ...
                                $swap_var = array(
                                    ...
                                    '{VER_LINK}' => 'http://localhost/salonbk/new_password.php?reset='.$code.'',
            ...
            $msg = "<div class='alert alert-danger'>Email Address is Required.</div>";
        }
    }
...
<head>
    <title>Salon Booking|Reset Password</title>
    <!-- Meta tag Keywords -->
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <div class="social-icons">
                            <p>Back to! <a href="signin_account.php">Login</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
